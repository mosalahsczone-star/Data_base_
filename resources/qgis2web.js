...
map.getView().fit([3595810.093742, 3461413.336665, 3603445.409673, 3469803.809421], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">قاعدة بيانات (09/02/2026)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (77 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'قاعدة بيانات توضح جميع المعلومات الخاصة بالمنشأت الصناعية بالهيئة الاقتصادية ';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_industrialfacility_2,
    colName: 'المنشأة الصناعية',
    zoom: 10,
    collapsed: true,
    map: map,
    maxResults: 10,
